...
____loclib.e13109h = "Кликая на шестиугольники, соберите картинку, затем введите текст на полученном изображении"
...
____loclib.discussed = "Обсуждаемое"
____loclib["Most Discussed Over"] = "За период"
...
____loclib.mnemonicnote = "Чтобы подтвердить что вы записали 12 слов, выберите первые 3 из них в правильном порядке"
____loclib.mnemonicerror = "Неверно введены 3 слова. Нажмите назад и запишите 12 слов для входа в Бастион."
____loclib.confirm = "Подтвердить"
____loclib.cameralocked = "Камера заблокирована"
____loclib.cameraunlocknote = "Для сканирования, разблокируйте камеру из настроек браузера и повторите попытку."
...
____loclib.scanqr = "Сканировать QR-код"
____loclib.usetor = "Соединение через Tor сеть"
____loclib.videotranscodingdelayedpost = "Данное видео еще обрабатывается, поэтому будет опубликовано после завершения этого процесса. Пожалуйста, не закрывайте вкладку до этого момента.";
____loclib.postInRelay = "Пост обрабатывается для отправки в блокчейн"
____loclib.cameraError1 = "Пользователь запретил доступ к камере."
____loclib.cameraError5 = "Камера недоступна, так как ее не существует или ее невозможно настроить по иным причинам."
